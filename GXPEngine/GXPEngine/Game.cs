...
namespace GXPEngine
{
	...
	public class Game : GameObject
	{
		...
		/// </param>
		public Game (int pWidth, int pHeight, bool pFullScreen, bool pVSync = true, int pRealWidth=-1, int pRealHeight=-1, bool pPixelArt=false, bool enableDepthBuffer=false, string gameName = "Game") : base()
		{
			if (pRealWidth <= 0) {
				pRealWidth = pWidth;
			}
			...
			if (main != null) {
				...
				_glContext.CreateWindow (pWidth, pHeight, pFullScreen, pVSync, pRealWidth, pRealHeight, enableDepthBuffer, gameName);
