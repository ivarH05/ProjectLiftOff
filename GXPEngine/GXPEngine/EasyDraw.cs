...
namespace GXPEngine
{
    ...
    public class EasyDraw : Canvas
    {
        ...
        /// <param name="addCollider">whether the canvas should have a collider</param>
        public EasyDraw(System.Drawing.Bitmap bitmap, bool addCollider = true, uint CollisionLayers = 0xFFFFFFFF, uint CoupleWithLayers = 0xFFFFFFFF) : base(bitmap, addCollider, CollisionLayers, CoupleWithLayers)
        {
            Initialize();
        }
        ...
        /// <param name="addCollider">whether the canvas should have a collider</param>
        public EasyDraw(string filename, bool addCollider = true, uint CollisionLayers = 0xFFFFFFFF, uint CoupleWithLayers = 0xFFFFFFFF) : base(filename, addCollider, CollisionLayers, CoupleWithLayers)
        {
            Initialize();
        }
