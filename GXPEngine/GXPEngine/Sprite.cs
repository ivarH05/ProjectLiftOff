...
namespace GXPEngine
{
    ...
    public class Sprite : GameObject
    {
        ...
        /// </param> 
        public Sprite(System.Drawing.Bitmap bitmap, bool addCollider = true, uint CollisionLayers = 0xFFFFFFFF, uint CoupleWithLayers = 0xFFFFFFFF) : base(addCollider, CollisionLayers, CoupleWithLayers)
        {
            if (Game.main == null)
            {
        ...
        /// If <c>true</c>, this sprite will have a collider that will be added to the collision manager.
        /// </param> 
        public Sprite(string filename, bool keepInCache = false, bool addCollider = true, uint CollisionLayers = 0xFFFFFFFF, uint CoupleWithLayers = 0xFFFFFFFF) : base(addCollider, CollisionLayers, CoupleWithLayers)
        {
            if (Game.main == null)
            {
                throw new Exception("Sprites cannot be created before creating a Game instance.");
        ...
        //														createCollider
        //------------------------------------------------------------------------------------------------------------------------
        protected override Collider createCollider(uint _CollisionLayers = 0xFFFFFFFF, uint _CoupleWithLayers = 0xFFFFFFFF)
        {
            return new BoxCollider(this, _CollisionLayers, _CoupleWithLayers);
        }
