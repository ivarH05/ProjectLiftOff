...
namespace TiledMapParser
{
    ...
    public class TiledLoader
    {
        ...
        public TiledLoader(string filename,
            ...
            uint CollisionLayers = 0xFFFFFFFF, uint CoupleWithLayers = 0xFFFFFFFF,
            ...
            bool highQualityText = true, bool autoInstance = false, ObjectCreateCallback callback = null)
        {
            ...
            this.CoupleWithLayers = CoupleWithLayers;
        ...
        /// <returns></returns>
        public static EasyDraw CreateTextField(TiledObject obj, bool addCollider = true, uint CollisionLayer = 0xFFFFFFFF, uint CoupleWithLayer = 0xFFFFFFFF, bool highQualityText = true)
        {
            float scaleMultiplier = highQualityText ? 2 : 1; // 1=as is. 2=better antialiasing, but 4 x size
            EasyDraw message = new EasyDraw((int)Mathf.Ceiling(obj.Width * scaleMultiplier), (int)Mathf.Ceiling(obj.Height * scaleMultiplier), addCollider, CollisionLayer, CoupleWithLayer);
            // TODO: Cache fonts?
        ...
        void LoadObjectGroup(int index, bool autoInstance = false)
        {
            ...
            foreach (TiledObject obj in group.Objects)
            {
                ...
                { // Create an AnimationSprite
                    ...
                    if (anim == null)
                    {
                        anim = new AnimationSprite(Path.Combine(_foldername, tileSet.Image.FileName), tileSet.Columns, tileSet.Rows, -1, false, addColliders, CollisionLayers, CoupleWithLayers);
                    }
                ...
                else if (obj.textField != null)
                {
                    ...
                    EasyDraw message = CreateTextField(obj, addColliders, CollisionLayers, CoupleWithLayers, highQualityText);
            ...
            for (int c = 0; c < tiles.GetLength(0); c++)
            {
                for (int r = 0; r < tiles.GetLength(1); r++)
                {
                    ...
                    AnimationSprite Tile = new AnimationSprite(
                        ...
                        -1, false, addColliders, CollisionLayers, CoupleWithLayers
                    );
        ...
        void LoadImageLayer(int index)
        {
            ...
            Sprite image = new Sprite(Path.Combine(_foldername, layer.Image.FileName), false, addColliders, CollisionLayers, CoupleWithLayers);
