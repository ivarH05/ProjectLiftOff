...
namespace GXPEngine
{
    ...
    public abstract class GameObject : Transformable
    {
        ...
        /// </param> 
        public GameObject(bool addCollider = false, uint _CollisionLayers = 0xFFFFFFFF, uint _CoupleWithLayers = 0xFFFFFFFF)
        {
            if (addCollider)
            {
                _collider = createCollider(_CollisionLayers, _CoupleWithLayers);
            }
        }
        ...
        /// </summary>
        protected virtual Collider createCollider(uint _CollisionLayers = 0xFFFFFFFF, uint _CoupleWithLayers = 0xFFFFFFFF)
        {
            return null;
        }
        ...
        {
            return _collider != null && other._collider != null && (_collider.CoupleWithLayers & other._collider.CollisionLayers) != 0 && _collider.HitTest(other._collider);
        }
        ...
        {
            normal = new Vector2();
            if (_collider == null || other._collider == null || parent == null || (_collider.CoupleWithLayers & other._collider.CollisionLayers) == 0)
